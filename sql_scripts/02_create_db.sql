...
--
-- Name: repository_stats; Type: SCHEMA; Schema: -; Owner: crowd
--

CREATE SCHEMA repository_stats;


ALTER SCHEMA repository_stats OWNER TO crowd;
...
CREATE EXTENSION IF NOT EXISTS "uuid-ossp" WITH SCHEMA crowd_public;
...
CREATE TABLE crowd_public.awsdms_ddl_audit (
    ...
    c_ddlqry character varying(1024),
    _fivetran_deleted boolean,
    _fivetran_synced timestamp with time zone
);
...
--
-- Name: customvieworders; Type: TABLE; Schema: crowd_public; Owner: crowd
--

CREATE TABLE crowd_public.customvieworders (
    id character varying(256) NOT NULL,
    "order" integer,
    customviewid character varying(256),
...
ALTER TABLE crowd_public.customvieworders OWNER TO crowd;

--
-- Name: customviews; Type: TABLE; Schema: crowd_public; Owner: crowd
--

CREATE TABLE crowd_public.customviews (
    id character varying(256) NOT NULL,
    name character varying(1020),
    visibility character varying(256),
    config jsonb,
    placement character varying(256),
    tenantid character varying(256),
    createdbyid character varying(256),
    updatedbyid character varying(256),
    createdat timestamp with time zone,
...
ALTER TABLE crowd_public.customviews OWNER TO crowd;
...
CREATE MATERIALIZED VIEW crowd_public.mv_commits_bus_factor AS
 WITH member_repo AS (
         SELECT i.row_number,
            ...
            i.username,
            i.cnt
           FROM ( SELECT row_number() OVER (PARTITION BY tr.time_range_name, a.segmentid, a.channel ORDER BY (count(DISTINCT
                        CASE
                  ...
                  GROUP BY tr.time_range_name, a.segmentid, a.channel, a.platform, a.username, a.memberid) i
          WHERE (i.row_number <= 20000)
          ORDER BY i.time_range_name, i.segment_id, i.repository_url, i.cnt DESC
        ), member_segment AS (
         SELECT i.row_number,
            i.time_range_name,
            i.segment_id,
         ...
         SELECT member_repo.time_range_name,
           ...
           FROM member_repo
          GROUP BY member_repo.time_range_name, member_repo.segment_id, member_repo.repository_url
        ), all_segment AS (
         ...
         SELECT mr.time_range_name,
            ...
            ((100.0 * (mr.cnt)::numeric) /
                CASE ar.cnt
                    ...
                    ELSE ar.cnt
                END) AS percent,
            ((100.0 * sum(mr.cnt) OVER (PARTITION BY mr.time_range_name, mr.segment_id, mr.repository_url ORDER BY mr.row_number ROWS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW)) /
                CASE ar.cnt
                    WHEN 0 THEN (1)::numeric
                    ELSE ar.cnt
                END) AS cumulative_percent
           FROM (member_repo mr
             JOIN all_repo ar ON ((((mr.segment_id)::text = (ar.segment_id)::text) AND ((mr.repository_url)::text = (ar.repository_url)::text) AND (mr.time_range_name = ar.time_range_name))))
          WHERE (mr.row_number <= 200)
          ORDER BY mr.time_range_name, mr.segment_id, mr.repository_url, mr.row_number
        ), cum_segment AS (
         ...
         SELECT (((((i.time_range_name || (i.segment_id)::text) || (i.repository_url)::text) || (i.member_id)::text) || (i.platform)::text) || (i.username)::text) AS pk_id,
            i.tenant_id,
            i.time_range_name,
            i.segment_id,
            i.repository_url,
           ...
           FROM (( SELECT '875c38bd-2b1b-4e91-ad07-0cfbabb4c49f'::text AS tenant_id,
                ...
                UNION
                 SELECT '875c38bd-2b1b-4e91-ad07-0cfbabb4c49f'::text AS tenant_id,
                    ...
                    'all-repos-combined'::character varying,
         ...
         SELECT bf_data.time_range_name,
          ...
          GROUP BY bf_data.time_range_name, bf_data.segment_id, bf_data.repository_url
        )
 SELECT d.pk_id,
    d.tenant_id,
    d.time_range_name,
    ...
    b.others_percent
   FROM (bf_data d
     JOIN bf b ON (((b.time_range_name = d.time_range_name) AND ((b.segment_id)::text = (d.segment_id)::text) AND ((b.repository_url)::text = (d.repository_url)::text))))
  WITH NO DATA;
...
--
-- Name: mv_contributions; Type: MATERIALIZED VIEW; Schema: crowd_public; Owner: crowd
--
...
ALTER TABLE crowd_public.mv_contributions OWNER TO crowd;
...
CREATE MATERIALIZED VIEW crowd_public.mv_da_committers AS
 WITH prev_committers AS (
         SELECT a.segmentid AS segment_id,
          ...
          GROUP BY a.segmentid, a.channel, a.platform, a.username, a.memberid
         ...
         SELECT i_1.segment_id,
           ...
           FROM ( SELECT a.segmentid AS segment_id,
                   ...
                   FROM crowd_public.activities a
                  WHERE (((a.type)::text = ANY ((ARRAY['authored-commit'::character varying, 'committed-commit'::character varying, 'co-authored-commit'::character varying, 'reviewed-commit'::character varying, 'signed-off-commit'::character varying, 'tested-commit'::character varying])::text[])) AND ((a.tenantid)::text = '875c38bd-2b1b-4e91-ad07-0cfbabb4c49f'::text) AND ((a.attributes ->> 'isMainBranch'::text) = 'true'::text) AND (a.deletedat IS NULL))
                  GROUP BY a.segmentid, a.channel, a.memberid, a.platform, a.username) i_1
          WHERE (i_1.commits >= 5)
 ...
 SELECT ((((((((((i.segment_id)::text || '/'::text) || '/'::text) || (i.repository_url)::text) || '/'::text) || (i.member_id)::text) || '/'::text) || (COALESCE(i.platform, '-'::character varying))::text) || '/'::text) || (COALESCE(i.username, '-'::character varying))::text) AS pk_id,
    now() AS "timestamp",
    i.segment_id,
    i.repository_url,
    i.member_id,
   ...
   FROM ( SELECT pc.segment_id,
           ...
           FROM ((prev_committers pc
             LEFT JOIN curr_committers cc ON ((((pc.segment_id)::text = (cc.segment_id)::text) AND ((pc.repository_url)::text = (cc.repository_url)::text) AND ((pc.member_id)::text = (cc.member_id)::text) AND ((pc.platform)::text = (cc.platform)::text) AND ((pc.username)::text = (cc.username)::text))))
             JOIN committers_all_time atc ON ((((pc.segment_id)::text = (atc.segment_id)::text) AND ((pc.repository_url)::text = (atc.repository_url)::text) AND ((pc.member_id)::text = (atc.member_id)::text) AND ((pc.platform)::text = (atc.platform)::text) AND ((pc.username)::text = (atc.username)::text))))
...
CREATE MATERIALIZED VIEW crowd_public.mv_da_contributors AS
 ...
 SELECT (((((((((i.segment_id)::text || '/'::text) || (i.repository_url)::text) || '/'::text) || (i.member_id)::text) || '/'::text) || (COALESCE(i.platform, '-'::character varying))::text) || '/'::text) || (COALESCE(i.username, '-'::character varying))::text) AS pk_id,
    now() AS "timestamp",
    i.segment_id,
    i.repository_url,
    i.member_id,
   ...
   FROM ( SELECT pc.segment_id,
           ...
           FROM ((prev_contributors pc
             LEFT JOIN curr_contributors cc ON ((((pc.segment_id)::text = (cc.segment_id)::text) AND ((pc.repository_url)::text = (cc.repository_url)::text) AND ((pc.member_id)::text = (cc.member_id)::text) AND ((pc.platform)::text = (cc.platform)::text) AND ((pc.username)::text = (cc.username)::text))))
             JOIN contributors_all_time atc ON ((((pc.segment_id)::text = (atc.segment_id)::text) AND ((pc.repository_url)::text = (atc.repository_url)::text) AND ((pc.member_id)::text = (atc.member_id)::text) AND ((pc.platform)::text = (atc.platform)::text) AND ((pc.username)::text = (atc.username)::text))))
          WHERE (cc.member_id IS NULL)
        UNION
         SELECT pc.segment_id,
            pc.repository_url,
 ...
 SELECT (((((((((i.segment_id)::text || '/'::text) || (i.repository_url)::text) || '/'::text) || (i.member_id)::text) || '/'::text) || (COALESCE(i.platform, '-'::character varying))::text) || '/'::text) || (COALESCE(i.username, '-'::character varying))::text) AS pk_id,
   ...
   FROM ( SELECT pc.segment_id,
           ...
           FROM ((prev_issuers pc
             LEFT JOIN curr_issuers cc ON ((((pc.segment_id)::text = (cc.segment_id)::text) AND ((pc.repository_url)::text = (cc.repository_url)::text) AND ((pc.member_id)::text = (cc.member_id)::text) AND ((pc.platform)::text = (cc.platform)::text) AND ((pc.username)::text = (cc.username)::text))))
             JOIN issuers_all_time atc ON ((((pc.segment_id)::text = (atc.segment_id)::text) AND ((pc.repository_url)::text = (atc.repository_url)::text) AND ((pc.member_id)::text = (atc.member_id)::text) AND ((pc.platform)::text = (atc.platform)::text) AND ((pc.username)::text = (atc.username)::text))))
          WHERE (cc.member_id IS NULL)
        UNION
         SELECT pc.segment_id,
            pc.repository_url,
...
CREATE MATERIALIZED VIEW crowd_public.mv_da_pr_contributors AS
 WITH prev_pullers AS (
         SELECT a.segmentid AS segment_id,
          ...
          GROUP BY a.segmentid, (split_part((a.channel)::text, '/pull/'::text, 1)), a.platform, a.username, a.memberid
         ...
         SELECT i_1.segment_id,
           ...
           FROM ( SELECT a.segmentid AS segment_id,
                   ...
                   FROM crowd_public.activities a
                  WHERE (((a.type)::text = ANY ((ARRAY['pull_request-opened'::character varying, 'pull_request-closed'::character varying, 'pull_request-merged'::character varying, 'pull_request-comment'::character varying, 'pull_request-reviewed'::character varying, 'pull_request-review-thread-comment'::character varying])::text[])) AND (NOT (((a.type)::text = 'pull_request-closed'::text) AND ((a.attributes ->> 'state'::text) = 'merged'::text))) AND (a.deletedat IS NULL) AND ((a.tenantid)::text = '875c38bd-2b1b-4e91-ad07-0cfbabb4c49f'::text))
                  GROUP BY a.segmentid, (split_part((a.channel)::text, '/pull/'::text, 1)), a.memberid, a.platform, a.username) i_1
          WHERE (i_1.pulls >= 5)
 ...
 SELECT (((((((((i.segment_id)::text || '/'::text) || i.repository_url) || '/'::text) || (i.member_id)::text) || '/'::text) || (COALESCE(i.platform, '-'::character varying))::text) || '/'::text) || (COALESCE(i.username, '-'::character varying))::text) AS pk_id,
    now() AS "timestamp",
    i.segment_id,
    i.repository_url,
    i.member_id,
   ...
   FROM ( SELECT pc.segment_id,
           ...
           FROM ((prev_pullers pc
             LEFT JOIN curr_pullers cc ON ((((pc.segment_id)::text = (cc.segment_id)::text) AND (pc.repository_url = cc.repository_url) AND ((pc.member_id)::text = (cc.member_id)::text) AND ((pc.platform)::text = (cc.platform)::text) AND ((pc.username)::text = (cc.username)::text))))
             JOIN pullers_all_time atc ON ((((pc.segment_id)::text = (atc.segment_id)::text) AND (pc.repository_url = atc.repository_url) AND ((pc.member_id)::text = (atc.member_id)::text) AND ((pc.platform)::text = (atc.platform)::text) AND ((pc.username)::text = (atc.username)::text))))
          WHERE (cc.member_id IS NULL)
        UNION
         SELECT pc.segment_id,
            pc.repository_url,
...
CREATE MATERIALIZED VIEW crowd_public.mv_new_activities AS
 ...
 SELECT (((((((((((((((i.aggregation_period || '/'::text) || i.contribution_type) || '/'::text) || (i."timestamp")::text) || '/'::text) || (i.segment_id)::text) || '/'::text) || '/'::text) || (i.repository_url)::text) || '/'::text) || (i.member_id)::text) || '/'::text) || (COALESCE(i.platform, '-'::character varying))::text) || '/'::text) || (COALESCE(i.username, '-'::character varying))::text) AS pk_id,
    i.segment_id,
    i.repository_url,
    i.member_id,
    i.platform,
   ...
   FROM ( SELECT fc.segment_id,
           ...
           FROM (crowd_public.activities a
             JOIN first_contribution fc ON (((a.deletedat IS NULL) AND ((a.memberid)::text = (fc.member_id)::text) AND ((a.platform)::text = (fc.platform)::text) AND ((a.username)::text = (fc.username)::text) AND ((a.channel)::text = (fc.repository_url)::text) AND ((a.segmentid)::text = (fc.segment_id)::text) AND (((a.type)::text = ANY ((ARRAY['pull_request-opened'::character varying, 'pull_request-closed'::character varying, 'pull_request-merged'::character varying, 'pull_request-comment'::character varying, 'pull_request-review-thread-comment'::character varying, 'pull_request-reviewed'::character varying, 'issues-closed'::character varying, 'issue-comment'::character varying, 'issues-opened'::character varying])::text[])) OR (((a.type)::text = ANY ((ARRAY['authored-commit'::character varying, 'co-authored-commit'::character varying, 'committed-commit'::character varying])::text[])) AND ((a.attributes ->> 'isMainBranch'::text) = 'true'::text))))))
          WHERE (a."timestamp" >= (now() - '91 days'::interval))
          GROUP BY fc.segment_id, fc.repository_url, fc.member_id, fc.platform, fc.username,
                CASE
                    WHEN ((a.type)::text = ANY ((ARRAY['authored-commit'::character varying, 'committed-commit'::character varying, 'co-authored-commit'::character varying])::text[])) THEN 'commit'::text
                    WHEN ((a.type)::text = ANY ((ARRAY['issues-opened'::character varying, 'issues-closed'::character varying, 'issue-comment'::character varying])::text[])) THEN 'issue'::text
                    WHEN ((a.type)::text = ANY ((ARRAY['pull_request-opened'::character varying, 'pull_request-closed'::character varying, 'pull_request-merged'::character varying, 'pull_request-comment'::character varying, 'pull_request-reviewed'::character varying, 'pull_request-review-thread-comment'::character varying])::text[])) THEN 'pull_request'::text
        ...
        UNION ALL
         SELECT fc.segment_id,
           ...
           FROM (crowd_public.activities a
             JOIN first_contribution fc ON (((a.deletedat IS NULL) AND ((a.memberid)::text = (fc.member_id)::text) AND ((a.platform)::text = (fc.platform)::text) AND ((a.username)::text = (fc.username)::text) AND ((a.channel)::text = (fc.repository_url)::text) AND ((a.segmentid)::text = (fc.segment_id)::text) AND (((a.type)::text = ANY ((ARRAY['pull_request-opened'::character varying, 'pull_request-closed'::character varying, 'pull_request-merged'::character varying, 'pull_request-comment'::character varying, 'pull_request-review-thread-comment'::character varying, 'pull_request-reviewed'::character varying, 'issues-closed'::character varying, 'issue-comment'::character varying, 'issues-opened'::character varying])::text[])) OR (((a.type)::text = ANY ((ARRAY['authored-commit'::character varying, 'co-authored-commit'::character varying, 'committed-commit'::character varying])::text[])) AND ((a.attributes ->> 'isMainBranch'::text) = 'true'::text))))))
          WHERE (a."timestamp" >= (now() - '7 mons'::interval))
          GROUP BY fc.segment_id, fc.repository_url, fc.member_id, fc.platform, fc.username,
                CASE
                    WHEN ((a.type)::text = ANY ((ARRAY['authored-commit'::character varying, 'committed-commit'::character varying, 'co-authored-commit'::character varying])::text[])) THEN 'commit'::text
                    WHEN ((a.type)::text = ANY ((ARRAY['issues-opened'::character varying, 'issues-closed'::character varying, 'issue-comment'::character varying])::text[])) THEN 'issue'::text
...
CREATE MATERIALIZED VIEW crowd_public.mv_org_bus_factor AS
 WITH company_repo AS (
         SELECT i.row_number,
            ...
            i.org_id,
            i.cnt
           FROM ( SELECT row_number() OVER (PARTITION BY tr.time_range_name, tm.type_name, a.segmentid, a.channel ORDER BY (count(DISTINCT
                        CASE
                  ...
                  GROUP BY tr.time_range_name, tm.type_name, a.segmentid, a.channel, a.organizationid) i
          WHERE (i.row_number <= 20000)
          ORDER BY i.time_range_name, i.type_name, i.segment_id, i.repository_url, i.cnt DESC
        ), company_segment AS (
         SELECT i.row_number,
            i.time_range_name,
            i.type_name,
         ...
         SELECT company_repo.time_range_name,
           ...
           FROM company_repo
          GROUP BY company_repo.time_range_name, company_repo.type_name, company_repo.segment_id, company_repo.repository_url
        ), all_segment AS (
         ...
         SELECT mr.time_range_name,
            ...
            ((100.0 * (mr.cnt)::numeric) /
                CASE ar.cnt
                    ...
                    ELSE ar.cnt
                END) AS percent,
            ((100.0 * sum(mr.cnt) OVER (PARTITION BY mr.time_range_name, mr.type_name, mr.segment_id, mr.repository_url ORDER BY mr.row_number ROWS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW)) /
                CASE ar.cnt
                    WHEN 0 THEN (1)::numeric
                    ELSE ar.cnt
                END) AS cumulative_percent
           FROM (company_repo mr
             JOIN all_repo ar ON ((((mr.segment_id)::text = (ar.segment_id)::text) AND ((mr.repository_url)::text = (ar.repository_url)::text) AND (mr.time_range_name = ar.time_range_name) AND (mr.type_name = ar.type_name))))
          WHERE (mr.row_number <= 200)
          ORDER BY mr.time_range_name, mr.type_name, mr.segment_id, mr.repository_url, mr.row_number
        ), cum_segment AS (
         SELECT ms.time_range_name,
            ms.type_name,
            ms.segment_id,
         ...
         SELECT ((((i.time_range_name || i.type) || (i.segment_id)::text) || (i.repository_url)::text) || (i.org_id)::text) AS pk_id,
            i.tenant_id,
            i.time_range_name,
            i.type,
            i.segment_id,
         ...
         SELECT bf_data.time_range_name,
           ...
           FROM bf_data
          WHERE (bf_data.cumulative_percent > 50.0)
          GROUP BY bf_data.time_range_name, bf_data.type, bf_data.segment_id, bf_data.repository_url
        )
 SELECT d.pk_id,
    d.tenant_id,
    d.time_range_name,
    ...
    b.others_percent
   FROM (bf_data d
     JOIN bf b ON (((b.time_range_name = d.time_range_name) AND (b.type = d.type) AND ((b.segment_id)::text = (d.segment_id)::text) AND ((b.repository_url)::text = (d.repository_url)::text))))
  WITH NO DATA;
 ...
 WITH company_repo AS (
         SELECT i.row_number,
           ...
           FROM ( SELECT row_number() OVER (PARTITION BY tr.time_range_name, a.segmentid, a.channel ORDER BY (count(DISTINCT
                  ...
                  GROUP BY tr.time_range_name, a.segmentid, a.channel, a.organizationid) i
          WHERE (i.row_number <= 20000)
          ORDER BY i.time_range_name, i.segment_id, i.repository_url, i.cnt DESC
        ), company_segment AS (
         SELECT i.row_number,
         ...
         SELECT company_repo.time_range_name,
            ...
            sum(company_repo.cnt) AS cnt
           FROM company_repo
          GROUP BY company_repo.time_range_name, company_repo.segment_id, company_repo.repository_url
        ), all_segment AS (
         SELECT company_segment.time_range_name,
            company_segment.segment_id,
            sum(company_segment.cnt) AS cnt
         ...
         SELECT (((i.time_range_name || (i.segment_id)::text) || (i.repository_url)::text) || (i.org_id)::text) AS pk_id,
            i.tenant_id,
            i.time_range_name,
            i.segment_id,
            i.repository_url,
...
CREATE MATERIALIZED VIEW crowd_public.mv_pr_engagement_gap AS
 WITH matching_activities AS (
         ...
         SELECT 'day'::text AS period,
          ...
          WHERE (matching_activities."timestamp" >= (now() - '91 days'::interval))
          GROUP BY (date(matching_activities."timestamp")), matching_activities.segment_id, matching_activities.repository_url, matching_activities.member_id
         ...
         SELECT 'week'::text AS period,
            ...
            count(DISTINCT matching_activities.id) AS contributions
           FROM matching_activities
          WHERE (matching_activities."timestamp" >= (now() - '7 mons'::interval))
          GROUP BY (date_trunc('week'::text, matching_activities."timestamp")), matching_activities.segment_id, matching_activities.repository_url, matching_activities.member_id
         ...
         SELECT 'month'::text AS period,
          ...
          GROUP BY (date_trunc('month'::text, matching_activities."timestamp")), matching_activities.segment_id, matching_activities.repository_url, matching_activities.member_id
         ...
         SELECT 'year'::text AS period,
          ...
          GROUP BY (date_trunc('year'::text, matching_activities."timestamp")), matching_activities.segment_id, matching_activities.repository_url, matching_activities.member_id
        ...
        UNION
         ...
         SELECT all_contributions.segment_id,
          ...
          GROUP BY all_contributions.segment_id, all_contributions.repository_url, all_contributions.period, all_contributions.period_date
        )
 SELECT ((((min_max_contributions.segment_id)::text || (min_max_contributions.repository_url)::text) || min_max_contributions.period) || (min_max_contributions.period_date)::text) AS id,
...
--
-- Name: mv_retention; Type: MATERIALIZED VIEW; Schema: crowd_public; Owner: crowd
--

CREATE MATERIALIZED VIEW crowd_public.mv_retention AS
 WITH all_contributors AS (
         SELECT a_1.segment_id,
            split_part((a_1.channel)::text, '/'::text, 4) AS repo_organization,
            a_1.channel AS repository_url,
            a_1.member_id,
            (min(a_1."timestamp"))::timestamp without time zone AS first_activity_at
           FROM crowd_public.mv_contributions a_1
          WHERE ((a_1.type)::text = ANY ((ARRAY['authored-commit'::character varying, 'committed-commit'::character varying, 'co-authored-commit'::character varying, 'issues-opened'::character varying, 'issues-closed'::character varying, 'issue-comment'::character varying, 'pull_request-opened'::character varying, 'pull_request-closed'::character varying, 'pull_request-merged'::character varying, 'pull_request-reviewed'::character varying, 'pull_request-comment'::character varying, 'pull_request-review-thread-comment'::character varying])::text[]))
          GROUP BY a_1.segment_id, (split_part((a_1.channel)::text, '/'::text, 4)), a_1.channel, a_1.member_id
         ...
         SELECT (date_trunc('month'::text, ac.first_activity_at))::date AS joined_month,
          ...
          GROUP BY ((date_trunc('month'::text, ac.first_activity_at))::date), ((date_trunc('week'::text, ac.first_activity_at))::date), ac.segment_id, ac.repo_organization, ac.repository_url
        ), activities_all_months AS (
         SELECT a_1.member_id AS activity_member_id,
            (date_trunc('month'::text, a_1."timestamp"))::date AS activity_month,
            (date_trunc('week'::text, a_1."timestamp"))::date AS activity_week,
            ajc.joined_month,
            ajc.joined_week,
            ajc.segment_id,
           ...
           FROM (all_joined_contributors ajc
             JOIN crowd_public.mv_contributions a_1 ON ((((a_1.segment_id)::text = (ajc.segment_id)::text) AND ((a_1.channel)::text = (ajc.repository_url)::text))))
          WHERE ((1 = 1) AND ((a_1.member_id)::text IN ( SELECT unnest(ajc.contributors_array) AS unnest)) AND ((a_1.type)::text = ANY ((ARRAY['authored-commit'::character varying, 'committed-commit'::character varying, 'co-authored-commit'::character varying, 'issues-opened'::character varying, 'issues-closed'::character varying, 'issue-comment'::character varying, 'pull_request-opened'::character varying, 'pull_request-closed'::character varying, 'pull_request-merged'::character varying, 'pull_request-reviewed'::character varying, 'pull_request-comment'::character varying, 'pull_request-review-thread-comment'::character varying])::text[])))
        )
 SELECT a.activity_member_id,
    a.activity_month,
    a.activity_week,
    a.joined_month,
    a.joined_week,
    ...
    a.repo_organization,
    a.repository_url,
    a.contributors_array
   FROM activities_all_months a
  WITH NO DATA;


ALTER TABLE crowd_public.mv_retention OWNER TO crowd;

--
-- Name: mv_retention_breakdown_sec; Type: MATERIALIZED VIEW; Schema: crowd_public; Owner: crowd
--

CREATE MATERIALIZED VIEW crowd_public.mv_retention_breakdown_sec AS
 WITH all_contributors AS (
         SELECT a.segment_id,
            a.channel AS repository_url,
            a.member_id,
            min(a."timestamp") AS first_activity_at
           FROM crowd_public.mv_contributions a
          GROUP BY a.segment_id, a.channel, a.member_id
        ), all_joined_contributors AS (
         SELECT (date_trunc('month'::text, ac.first_activity_at))::date AS joined_month,
            (date_trunc('week'::text, ac.first_activity_at))::date AS joined_week,
            ac.segment_id,
            ...
            array_agg(DISTINCT ac.member_id) AS contributors_array
           FROM all_contributors ac
          GROUP BY ((date_trunc('month'::text, ac.first_activity_at))::date), ((date_trunc('week'::text, ac.first_activity_at))::date), ac.segment_id, ac.repository_url
        ), activities_all_months AS (
         SELECT a.member_id AS activity_member_id,
          ...
          WHERE (((a.channel)::text = (ajc.repository_url)::text) AND ((a.segment_id)::text = (ajc.segment_id)::text) AND ((a.member_id)::text IN ( SELECT unnest(ajc.contributors_array) AS unnest)))
        )
...
ALTER TABLE crowd_public.mv_retention_breakdown_sec OWNER TO crowd;
...
CREATE MATERIALIZED VIEW crowd_public.mv_type_bus_factor AS
 WITH member_repo AS (
           ...
           FROM ( SELECT row_number() OVER (PARTITION BY tr.time_range_name, tm.type_name, a.segmentid, a.channel ORDER BY (count(DISTINCT
                   ...
                   FROM crowd_public.mv_time_ranges tr,
                    ...
                    (crowd_public.activities a
                     JOIN crowd_public.members m ON (((a.memberid)::text = (m.id)::text)))
                  WHERE (((a.tenantid)::text = '875c38bd-2b1b-4e91-ad07-0cfbabb4c49f'::text) AND ((((m.attributes -> 'isBot'::text) ->> 'default'::text) IS NULL) OR (((m.attributes -> 'isBot'::text) ->> 'default'::text) <> 'true'::text)) AND (a."timestamp" >= tr.time_range_from) AND (a."timestamp" < tr.time_range_to) AND ((a.type)::text = ANY (tm.types)) AND (((a.type)::text = ANY ((ARRAY['pull_request-opened'::character varying, 'pull_request-closed'::character varying, 'pull_request-merged'::character varying, 'pull_request-comment'::character varying, 'pull_request-review-thread-comment'::character varying, 'pull_request-reviewed'::character varying, 'issues-closed'::character varying, 'issue-comment'::character varying, 'issues-opened'::character varying])::text[])) OR (((a.type)::text = ANY ((ARRAY['authored-commit'::character varying, 'co-authored-commit'::character varying, 'committed-commit'::character varying])::text[])) AND ((a.attributes ->> 'isMainBranch'::text) = 'true'::text))) AND (NOT (((a.type)::text = 'pull_request-closed'::text) AND ((a.attributes ->> 'state'::text) = 'merged'::text))))
                  GROUP BY tr.time_range_name, tm.type_name, a.segmentid, a.channel, a.platform, a.username, a.memberid) i
          WHERE (i.row_number <= 20000)
          ORDER BY i.time_range_name, i.type_name, i.segment_id, i.repository_url, i.cnt DESC
        ), member_segment AS (
         SELECT i.row_number,
         ...
         SELECT member_repo.time_range_name,
            ...
            sum(member_repo.cnt) AS cnt
           FROM member_repo
          GROUP BY member_repo.time_range_name, member_repo.type_name, member_repo.segment_id, member_repo.repository_url
        ), all_segment AS (
         SELECT member_segment.time_range_name,
         ...
         SELECT ((((((i.time_range_name || i.type) || (i.segment_id)::text) || (i.repository_url)::text) || (i.member_id)::text) || (i.platform)::text) || (i.username)::text) AS pk_id,
            i.tenant_id,
            i.time_range_name,
            i.type,
            i.segment_id,
...
--
-- Name: repositories; Type: TABLE; Schema: crowd_public; Owner: crowd
--

CREATE TABLE crowd_public.repositories (
    repository character varying(2048) NOT NULL
);


ALTER TABLE crowd_public.repositories OWNER TO crowd;

--
-- Name: repositories_processing; Type: TABLE; Schema: crowd_public; Owner: crowd
--

CREATE TABLE crowd_public.repositories_processing (
    repository character varying(2048) NOT NULL,
    source character varying(255) NOT NULL
);


ALTER TABLE crowd_public.repositories_processing OWNER TO crowd;

--
-- Name: repository_reports; Type: TABLE; Schema: crowd_public; Owner: crowd
--

CREATE TABLE crowd_public.repository_reports (
    id uuid DEFAULT crowd_public.uuid_generate_v4() NOT NULL,
    repository character varying(2048) NOT NULL,
    source character varying(255) NOT NULL,
...
ALTER TABLE crowd_public.repository_reports OWNER TO crowd;
...
--
-- Name: repository_reports; Type: TABLE; Schema: repository_stats; Owner: crowd
--

CREATE TABLE repository_stats.repository_reports (
    id uuid DEFAULT crowd_public.uuid_generate_v4() NOT NULL,
    repository character varying(2048) NOT NULL,
    source character varying(255) NOT NULL,
    report jsonb NOT NULL,
...
ALTER TABLE repository_stats.repository_reports OWNER TO crowd;
...
--
-- Name: customvieworders customvieworders_pkey; Type: CONSTRAINT; Schema: crowd_public; Owner: crowd
--

ALTER TABLE ONLY crowd_public.customvieworders
    ADD CONSTRAINT customvieworders_pkey PRIMARY KEY (id);


--
-- Name: customviews customviews_pkey; Type: CONSTRAINT; Schema: crowd_public; Owner: crowd
--

ALTER TABLE ONLY crowd_public.customviews
...
--
-- Name: repository_reports repository_reports_pkey; Type: CONSTRAINT; Schema: crowd_public; Owner: crowd
--

ALTER TABLE ONLY crowd_public.repository_reports
    ADD CONSTRAINT repository_reports_pkey PRIMARY KEY (id);
...
--
-- Name: repository_reports repository_reports_pkey; Type: CONSTRAINT; Schema: repository_stats; Owner: crowd
--

ALTER TABLE ONLY repository_stats.repository_reports
    ADD CONSTRAINT repository_reports_pkey PRIMARY KEY (id);
...
--
-- Name: idx_mv_contributions_channel; Type: INDEX; Schema: crowd_public; Owner: crowd
--
...
--
-- Name: idx_mv_contributions_foundation; Type: INDEX; Schema: crowd_public; Owner: crowd
--
...
--
-- Name: idx_mv_contributions_id; Type: INDEX; Schema: crowd_public; Owner: crowd
--
...
--
-- Name: idx_mv_contributions_member_id; Type: INDEX; Schema: crowd_public; Owner: crowd
--
...
--
-- Name: idx_mv_contributions_on_member_id_segment_id_channel; Type: INDEX; Schema: crowd_public; Owner: crowd
--
...
--
-- Name: idx_mv_contributions_org_url; Type: INDEX; Schema: crowd_public; Owner: crowd
--
...
--
-- Name: idx_mv_contributions_organization_id; Type: INDEX; Schema: crowd_public; Owner: crowd
--
...
--
-- Name: idx_mv_contributions_project; Type: INDEX; Schema: crowd_public; Owner: crowd
--
...
--
-- Name: idx_mv_contributions_segment_id; Type: INDEX; Schema: crowd_public; Owner: crowd
--
...
--
-- Name: idx_mv_contributions_timestamp; Type: INDEX; Schema: crowd_public; Owner: crowd
--
...
--
-- Name: idx_mv_contributions_type; Type: INDEX; Schema: crowd_public; Owner: crowd
--
...
--
-- Name: idx_mv_retention_activity_member_id; Type: INDEX; Schema: crowd_public; Owner: crowd
--

CREATE INDEX idx_mv_retention_activity_member_id ON crowd_public.mv_retention USING btree (activity_member_id);


--
-- Name: idx_mv_retention_activity_month; Type: INDEX; Schema: crowd_public; Owner: crowd
--

CREATE INDEX idx_mv_retention_activity_month ON crowd_public.mv_retention USING btree (activity_month);


--
-- Name: idx_mv_retention_activity_week; Type: INDEX; Schema: crowd_public; Owner: crowd
--

CREATE INDEX idx_mv_retention_activity_week ON crowd_public.mv_retention USING btree (activity_week);


--
-- Name: idx_mv_retention_joined_month; Type: INDEX; Schema: crowd_public; Owner: crowd
--

CREATE INDEX idx_mv_retention_joined_month ON crowd_public.mv_retention USING btree (joined_month);


--
-- Name: idx_mv_retention_joined_week; Type: INDEX; Schema: crowd_public; Owner: crowd
--

CREATE INDEX idx_mv_retention_joined_week ON crowd_public.mv_retention USING btree (joined_week);


--
-- Name: idx_mv_retention_repo_organization; Type: INDEX; Schema: crowd_public; Owner: crowd
--

CREATE INDEX idx_mv_retention_repo_organization ON crowd_public.mv_retention USING btree (repo_organization);


--
-- Name: idx_mv_retention_repository_url; Type: INDEX; Schema: crowd_public; Owner: crowd
--

CREATE INDEX idx_mv_retention_repository_url ON crowd_public.mv_retention USING btree (repository_url);


--
-- Name: idx_mv_retention_segment_id; Type: INDEX; Schema: crowd_public; Owner: crowd
--

CREATE INDEX idx_mv_retention_segment_id ON crowd_public.mv_retention USING btree (segment_id);
...
--
-- Name: TABLE customvieworders; Type: ACL; Schema: crowd_public; Owner: crowd
--

GRANT SELECT ON TABLE crowd_public.customvieworders TO crowd_ro;
GRANT SELECT ON TABLE crowd_public.customvieworders TO cube;


--
-- Name: TABLE customviews; Type: ACL; Schema: crowd_public; Owner: crowd
--

GRANT SELECT ON TABLE crowd_public.customviews TO crowd_ro;
GRANT SELECT ON TABLE crowd_public.customviews TO cube;
...
--
-- Name: TABLE mv_contributions; Type: ACL; Schema: crowd_public; Owner: crowd
--

GRANT SELECT ON TABLE crowd_public.mv_contributions TO crowd_ro;
GRANT SELECT ON TABLE crowd_public.mv_contributions TO cube;
...
--
-- Name: TABLE mv_retention; Type: ACL; Schema: crowd_public; Owner: crowd
--

GRANT SELECT ON TABLE crowd_public.mv_retention TO crowd_ro;
GRANT SELECT ON TABLE crowd_public.mv_retention TO cube;


--
-- Name: TABLE mv_retention_breakdown_sec; Type: ACL; Schema: crowd_public; Owner: crowd
--

GRANT SELECT ON TABLE crowd_public.mv_retention_breakdown_sec TO crowd_ro;
GRANT SELECT ON TABLE crowd_public.mv_retention_breakdown_sec TO cube;
...
--
-- Name: TABLE repositories; Type: ACL; Schema: crowd_public; Owner: crowd
--

GRANT SELECT ON TABLE crowd_public.repositories TO crowd_ro;
GRANT SELECT ON TABLE crowd_public.repositories TO cube;


--
-- Name: TABLE repositories_processing; Type: ACL; Schema: crowd_public; Owner: crowd
--

GRANT SELECT ON TABLE crowd_public.repositories_processing TO crowd_ro;
GRANT SELECT ON TABLE crowd_public.repositories_processing TO cube;


--
-- Name: TABLE repository_reports; Type: ACL; Schema: crowd_public; Owner: crowd
--

GRANT SELECT ON TABLE crowd_public.repository_reports TO crowd_ro;
GRANT SELECT ON TABLE crowd_public.repository_reports TO cube;
